...
const About = () => {
  ...
  return (
    <div className="min-h-screen p-2">
      ...
      <section 
        ref={heroRef}
        className="relative h-[60vh] rounded-3xl flex items-center justify-center overflow-hidden px-6 sm:px-8 lg:px-10"
      >
        <motion.img
          style={{ y, scale: 1.1 }}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-12 flex flex-col justify-center">
                <motion.h2 
                  ...
                  transition={{ duration: 0.8, delay: 0.2, ease: "easeOut" }}
                  viewport={{ once: true }}
                  className="text-4xl font-bold mb-8 font-domine"
                >
                  Our Story
                </motion.h2>
                <motion.p 
              ...
              >
                <Card className={`h-full shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:shadow-[0_12px_40px_rgba(187,154,101,0.4)] transition-all duration-300 rounded-3xl border-0 bg-white hover:scale-[1.01] group`}>
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-semibold mb-4 font-domine group-hover:text-[#bb9a65] transition-colors duration-300">{value.title}</h3>
